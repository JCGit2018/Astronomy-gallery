		...
		var paused = false;
		var howtotext="Click on the big image to see the description without image sliding. Click on the BACK and FWD buttons to go through the images. Click on the image to see it in big size with the corresponding description";
